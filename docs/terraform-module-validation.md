...
- `cicd-repository` - Default: "alphagov/gds-github-workflows". The repository to pull the CI/CD workflows from
...
- `organization-name` - Default: "gds". The name of the GitHub organization
